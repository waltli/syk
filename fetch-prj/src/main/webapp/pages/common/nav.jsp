...
<nav class="navbar navbar-default navbar-fixed-top">
	...
	<div class="container-fluid">
		...
		<form class="navbar-form navbar-left" action="${ctx }/movie/list" method="get">
			<div class="input-group">
				<input type="text" name="q" value="${params.q }" class="form-control" placeholder="Search dashboard..." style="width:300px;">
...
<div id="sidebar-nav" class="sidebar">
	<div class="sidebar-scroll">
		<nav>
			<ul class="nav">
				<li><a href="${ctx }/movie/list" class="" id="list"><i class="lnr lnr-home"></i> <span>Dashboard</span></a></li>
				<li>
					<a href="#subPages" data-toggle="collapse" class="collapsed" id="add"><i class="lnr lnr-file-empty"></i> <span>Add Movie Around</span> <i class="icon-submenu lnr lnr-chevron-left"></i></a>
					<div id="subPages" class="collapse ">
						<ul class="nav">
							<li><a href="${ctx }/movie/search-from-douban">From Douban.com</a></li>
							<li><a href="${ctx }/movie/add-page">Normal</a></li>
						</ul>
					</div>
				</li>
			</ul>
