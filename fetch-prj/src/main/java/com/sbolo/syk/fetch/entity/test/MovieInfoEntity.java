...
public class MovieInfoEntity {
    ...
    /**
     * 获取多个posterUri组成的json
     *
     * @return poster_uri_json - 多个posterUri组成的json
     */
    ...
    /**
     * 设置多个posterUri组成的json
     *
     * @param posterUriJson 多个posterUri组成的json
     */
