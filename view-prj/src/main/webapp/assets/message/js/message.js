...
_tips.push('  		</a>');
_tips.push('		<a class="ds-ctx-open" href="javascript:void(0);" more_message="显示多层对话" data-user-prn="{%prn}" data-prn="{%msgPrn}" prnLine="{%prnLine}">查看对话</a>');
_tips.push('  	</p>');
_tips.push('  </div>');
...
var loadMessage = function(){
	...
	$("#ds-thread").on('click',"a.ds-post-reply",function(){
		...
		$(this).parent().after(syk.fmt(xhtml, $.extend(token,{"parentPrn":parentPrn,location:"smallComment",msgLevel:msgLevel,prnLine:prnLine,rootPrn:rootPrn})));
